    ...
    <div class="admin-layout">
        ...
        <main class="main-content">
            ...
            <?php if ($categoryModel->getProductCount($category['id']) > 0): ?>
                <div class="info-box">
                    <strong>⚠️ Atención:</strong> Esta categoría tiene productos asociados. Si cambias el tipo de producto, 
                    los productos existentes conservarán sus campos actuales, pero los nuevos productos usarán los campos del nuevo tipo.
                </div>
            <?php endif; ?>
